...
button {
    ...
    <div class="container">
        ...
        <button style="border:none;" class="nav-item  text-muted" >Back</button>
        </form>
                        </li>
                        <a class="text-secondary nav-item">-----</a>
                        </li>
                        <form action="wanted-animal-list.php" method="post" class="nav-item">
        <button style="border:none;"class="nav-item">
        Enter the List of animals we want to aquire</button>
        </form>
                    </ul>
                </div>
        ...
        <div class="card" >
            ...
            <div class="card-body">
              <h5 class="card-title">Alaskan Klee Kai</h5>
              <p class="card-text">Small, energetic</p>
            </div>
          ...
          <div class="card" >
            ...
            <div class="card-body">
              ...
              <p class="card-text">Strong heavy</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item "><a class="btn btn-primary" href="#" role="button">More Details</a></li>
            </ul>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">American Buldog</h5>
        ...
        <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">American Hound</h5>
